    ...
    <header className="shadow-inner bg-opacity-15 w-[90%] md:w-[70%] lg:w-[75%] lg:max-w-screen-xl top-5 mx-auto sticky border border-secondary z-40 rounded-2xl flex justify-between items-center p-2 bg-card">
              ...
              <SheetHeader className="mb-4 ml-4">
                <SheetTitle className="flex items-center">
                  <Link href="/" className="flex items-center">
                    <Image src="/logo.png" alt="Shadcn" width={35} height={35} className="rounded-lg mr-2" /> Dibuiltadi
                  </Link>
                </SheetTitle>
              </SheetHeader>
          ...
          {/* <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <div className="grid w-[600px] grid-cols-2 p-4">
                <Image src="/logo.png" alt="Shadcn" width={35} height={35} className="" />
      ...
      <div className="hidden lg:flex">
        ...
        {/* <Button asChild size="sm" variant="ghost" aria-label="View on GitHub">
          <Link aria-label="View on GitHub" href="https://github.com/nobruf/shadcn-landing-page.git" target="_blank">

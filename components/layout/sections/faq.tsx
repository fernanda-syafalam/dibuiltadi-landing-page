...
const FAQList: FAQProps[] = [
  {
    question: "What services does PT Dibuiltadi Solusi Teknologi provide?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, we develop mobile apps for both platforms with a focus on performance, user experience, and seamless functionality.",
    value: "item-4",
  },
  {
